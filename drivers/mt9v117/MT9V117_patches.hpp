...
/*
 * Copyright(c) ArduPilot project
 * Author: Julien BERAUD <julien.beraud@parrot.com>
 *
 * Modofied to use in DriverFramework
 *		2017 PX4 Development Team
 *
 */
...
const struct mt9v117_patch MT9V117_patch_lines[MT9V117_PATCH_LINE_NUM] = {
